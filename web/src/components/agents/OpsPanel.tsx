...
// Shows fleet overview, flat delegation team roster with inline detail cards,
...
import { selectedAgent, agentList, getDelegationTargetsFor, agentHealth } from '../../stores/agents';
import {
  getWorkerAgentsFor,
  getAgentConcurrency,
  getAgentRuns,
  ...
  return (
    <div class="h-full overflow-y-auto overscroll-contain">
      <div class="max-w-4xl mx-auto px-6 py-5 space-y-6">
        ...
        <div class="rounded-xl border border-border bg-surface overflow-hidden">
          <div class="px-4 py-3 border-b border-border-subtle">
            <h3 class="text-xs font-semibold text-text uppercase tracking-wider">Delegation Team</h3>
          </div>
...
// ── Agent Tree Node (flat, clickable for detail) ──
...
function AgentTreeNode(props: {
  ...
  return (
    <div>
      {/* Main node row — clickable to toggle detail card */}
      <div
